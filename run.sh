...
echo
echo "=== 6b. M3 tests ==="
python3 test_m3.py || exit 1

echo
echo "=== 6c. Auth / RBAC tests ==="
python3 test_auth.py || exit 1
...
echo "                   http://127.0.0.1:5000  ->  redirects to /login"
echo
echo "  Sign in with:    doctor@hospital.com     / password123"
echo "                   nurse@hospital.com      / password123"
echo "                   reception@hospital.com  / password123"
